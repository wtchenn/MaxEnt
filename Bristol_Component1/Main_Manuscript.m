...
opts = detectImportOptions(".\Data Source\Bristol_Data_Cleaned.xlsx",'ReadVariableNames',true,'PreserveVariableNames',true);

% Specify sheet and range
opts.Sheet = "Sheet1";
opts.DataRange = "A2:AU524";
...
% Import the data
Count_Table = readtable(".\Data Source\Bristol_Data_Cleaned.xlsx", opts);
...
% Specify sheet and range
opts.Sheet = "LatLongs";
opts.DataRange = "A2:G42";

% Specify column names and types
opts.VariableNames = ["Location_ID", "ProjectName", "SensorNumber","Sensor", "Latitude", "Longitude", "Comment"];
opts.VariableTypes = ["double", "char", "char","char", "double", "double", "char"];

% Import the data
Sensor_Info = readtable(".\Data Source\Bristol Lat_Longs.xlsx", opts, "UseExcel", false);
...
%%Show Pictures
% my_show_network_with_map(A,[Node_Table.y,Node_Table.x],'b.-')
% saveas(gca,'Map.fig')
...
for Distance_Threshold = 1000:-50:200
